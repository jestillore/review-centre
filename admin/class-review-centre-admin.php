...
class Review_Centre_Admin {
	...
	private function __construct() {
		...
		$plugin = Review_Centre::get_instance();
	...
	public function enqueue_admin_styles() {
		...
		if ( $this->plugin_screen_hook_suffix == $screen->id ) {
			wp_enqueue_style( $this->plugin_slug .'-admin-styles', plugins_url( 'assets/css/admin.css', __FILE__ ), array(), Review_Centre::VERSION );
		}
	...
	public function enqueue_admin_scripts() {
		...
		$screen = get_current_screen();
		if ( $this->plugin_screen_hook_suffix == $screen->id ) {
			wp_enqueue_script( $this->plugin_slug . '-admin-script', plugins_url( 'assets/js/admin.js', __FILE__ ), array( 'jquery' ), Review_Centre::VERSION );
		}
